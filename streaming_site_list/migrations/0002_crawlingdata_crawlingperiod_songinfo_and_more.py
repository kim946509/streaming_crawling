# Generated by Django 4.2.21 on 2025-07-07 02:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='생성시간')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='수정시간')),
                ('title', models.CharField(help_text='곡 제목', max_length=255)),
                ('artist', models.CharField(help_text='아티스트명', max_length=255)),
                ('youtube_url', models.URLField(blank=True, help_text='YouTube URL', max_length=500, null=True)),
                ('melon_song_id', models.CharField(blank=True, help_text='멜론 곡 ID', max_length=100, null=True)),
            ],
            options={
                'db_table': 'song_info',
