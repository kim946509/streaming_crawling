...
# ---------- ⬇️ crawler 함수 호출 ----------
from streaming_site_list.youtube.crawling_view.crawler import save_each_to_csv
from streaming_site_list.youtube_music.crawling_view.crawler import YouTubeMusicSongCrawler
from celery_setup.tasks import (
    youtube_music_crawl_rhoonart,
...
class YouTubeMusicSongViewCountAPIView(APIView):
        ...
        request_body=openapi.Schema(
            ...
            properties={
                'urls': openapi.Schema(
                    ...
                    description="크롤링할 유튜브 뮤직 노래 주소 목록"
                ),
            ...
            example={
                'urls': ["https://music.youtube.com/watch?v=Sv2mIvMwrSY", "https://music.youtube.com/watch?v=R1CZTJ8hW0s"],
    ...
    def post(self, request):
        ...
        if immediate:
            results = YouTubeMusicSongCrawler(urls)
